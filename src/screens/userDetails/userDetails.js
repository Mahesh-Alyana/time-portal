        ...
        <div className="centerbar">
          ...
          <div className="gameDetailsBG">
            <div className="gameDetails">
              ...
              <h3> Score : {memoryGame.score}</h3>
              <h3> Started : {memoryGame.started ? "Yes" : " No"}</h3>
              <h3> Completed : {memoryGame.completed ? "Yes" : " No"}</h3>
              <h3> Accuracy : {memoryGame.accuracy}</h3>
            </div>
            <div className="gameDetails">
              <h3>
                <u>Sliding Game</u>
              </h3>
              <h3> Score : {slidingGame.score}</h3>
              <h3> Started : {slidingGame.started ? "Yes" : " No"}</h3>
              <h3> Completed : {slidingGame.completed ? "Yes" : " No"}</h3>
              <h3> Accuracy : {slidingGame.accuracy}</h3>
            </div>
            <div className="gameDetails">
              <h3>
                <u>Sudoku Game</u>
              </h3>
              <h3> Score : {sudoku.score}</h3>
              <h3> Started : {sudoku.started ? "Yes" : " No"}</h3>
              <h3> Completed : {sudoku.completed ? "Yes" : " No"}</h3>
              <h3> Accuracy : {sudoku.accuracy}</h3>
            </div>
          </div>
